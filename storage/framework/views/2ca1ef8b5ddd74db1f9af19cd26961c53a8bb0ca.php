                    ...
                    <div class="tab-pane active" id="userSettings" role="tabpanel">
                        <div class="kt-section">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-4">
                                    <label>TG ID:</label>
                                    <input type="text" autocomplete="off" disabled class="form-control" placeholder="" value="<?php echo e($user->tg_id); ?>" name="balance" required />
                                </div>
                                <div class="col-lg-4">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <input
                                        ...
                                        class="form-control"
                                        placeholder=""
                                        value="<?php echo e(number_format($user->allingame, 2, '.', '')); ?>"
                                        disabled
                                    />
                                </div>
                            </div>
...
$(document).ready(function() {
    ...
    $('#from_date, #to_date').on('change', function() {
        ...
        // Очищаємо існуючі пошукові функції
    ...
    function parseDate(dateText) {
        // Перетворюємо формат "31.01.25 в 16:47:18" в об'єкт Date
        let dateParts = dateText.split(' в ')[0].split('.');
        let day = dateParts[0];
        let month = dateParts[1] - 1;  // Місяці у JavaScript починаються з 0
...
<?php echo $__env->make('admin/layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/admin/users/edit.blade.php ENDPATH**/ ?>