...
<html lang="en">
    <head>
        ...
        <link href="/dash/css/style.bundle.css?v=2" rel="stylesheet" type="text/css" />
    ...
    <body class="kt-header--fixed kt-header-mobile--fixed kt-subheader--fixed kt-subheader--enabled kt-subheader--solid kt-aside--enabled kt-aside--fixed kt-page--loading">
                    ...
                    <div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
                        <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">
                            <ul class="kt-menu__nav ">
                                ...
                                <li class="kt-menu__item <?php echo e(Request::is('admin/promocodes*') ? 'kt-menu__item--active' : ''); ?>" aria-haspopup="true">
                                ...
                                <li class="kt-menu__item <?php echo e(Request::is('admin/antiminus') ? 'kt-menu__item--active' : ''); ?>" aria-haspopup="true">
                                ...
                                <li class="kt-menu__item <?php echo e(Request::is('admin/deposits') ? 'kt-menu__item--active' : ''); ?>" aria-haspopup="true">
                                ...
                                <li class="kt-menu__item <?php echo e(Request::is('admin/withdraws') ? 'kt-menu__item--active' : ''); ?>" aria-haspopup="true">
                                    <a href="<?php echo e(route('admin.withdraws')); ?>" class="kt-menu__link">
                                        ...
                                        <span class="btn-sm btn-success" style="margin-top: -2px;"><?php echo e(\App\Withdraw::where([['is_youtuber', 0], ['status', 0]])->count()); ?></span>
                                    </a>
                                </li>
                                <li class="kt-menu__item <?php echo e(Request::is('admin/bonus') ? 'kt-menu__item--active' : ''); ?>" aria-haspopup="true">
									<a href="<?php echo e(route('admin.bonus')); ?>" class="kt-menu__link">
										...
										<span class="kt-menu__link-text">Настройка бонусов</span>
									</a>
								</li>
                                <li class="kt-menu__item" aria-haspopup="true">
                                    <a href="https://shadowfight.fun/LDHlsy7zHUYQ72JAz/" target="_blank" class="kt-menu__link">
										<span class="kt-menu__link-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        ...
                                        <span class="kt-menu__link-text">База данных</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
                            ...
                            <div id="kt_header_menu" class="kt-header-menu kt-header-menu-mobile  kt-header-menu--layout-default ">
                                <ul class="kt-menu__nav ">
                                    <li class="kt-menu__item  kt-menu__item--open kt-menu__item--here kt-menu__item--submenu kt-menu__item--rel kt-menu__item--open kt-menu__item--here">
                                        <button type="button" class="btn btn-success versionUpdate">Обновить версию файлов</button>
                                    </li>
                                    <li class="d-none kt-menu__item  kt-menu__item--open kt-menu__item--here kt-menu__item--submenu kt-menu__item--rel kt-menu__item--open kt-menu__item--here">
                                        <button type="button" class="btn btn-primary socketStop">Выключить сокет</button>
                                    </li>
                                </ul>
                            </div>
                        </div>
        ...
        <div class="modal fade" id="multiChecker" tabindex="-1" role="dialog" aria-labelledby="newLabel" style="display: none;" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle">Проверка на мультиаккаунты</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <form class="kt-form-new" action="#" id="save">
                        <div class="modal-body">
                            <div class="form-group">
                                <label for="login_multi">Логин:</label>
                                <input type="text" class="form-control" placeholder="" id="login_multi" disabled readonly />
                            </div>
                            <div class="form-group">
                                <label for="list_multi">
                                    Найдено мультиаккаунтов:&nbsp;<span id="count_multi"></span>
                                </label>
                                <textarea type="text" class="form-control" id="list_multi"></textarea>
                            </div>
                        </div>
                ...
                .then(response => {
                    ...
                    if (response.list.length !== 0) {
                        ...
                        response.list.map((item, index) => {
                            textareaValue += item.username + '(id:' + item.id + ')';
                            if (index !== response.list.length - 1) {
                                textareaValue += '\n'; // добавить перенос строки между каждым результатом
                            }
                        });

                        $('#list_multi').val(textareaValue);
                        $('#count_multi').html(response.list.length);
                    }
...
<?php /**PATH /var/www/resources/views/admin/layout.blade.php ENDPATH**/ ?>